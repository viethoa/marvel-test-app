...
import com.viethoa.potdemo.widgets.snackbars.BottomSnackBar;
 ...
 */
public class MovieAdapter extends BaseArrayAdapter<Movie> {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        if (convertView == null) {
            convertView = LayoutInflater.from(context).inflate(R.layout.item_movie, viewGroup, false);
    ...
    static class ViewHolder extends RecyclerView.ViewHolder {
        ...
        void bind(Context context, Movie movie) {
            ...
            // Background
            GlideUtils.loadImage(context, movie.getImageUrl(),
                    GlideUtils.Size.W300, imgBackground, R.drawable.placeholder_image_v);
